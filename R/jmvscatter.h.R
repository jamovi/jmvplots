...
jmvscatterOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jmvscatterOptions",
...
jmvscatterResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jmvscatterResults",
...
jmvscatterBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "jmvscatterBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = jmvscatterResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
jmvscatter <- function(
    ...
    if ( ! requireNamespace("jmvcore", quietly=TRUE))
        stop("jmvscatter requires jmvcore to be installed (restart may be required)")
